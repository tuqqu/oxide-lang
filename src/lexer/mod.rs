...
impl Lexer {
    ...
    pub fn tokenize(&mut self) -> (&Vec<Token>, bool) {
        ...
        self.tokens
            .push(Token::new(TokenType::Eof, String::from(""), String::from(""), self.pos()));
    ...
    fn add_token_with_literal(&mut self, token_type: TokenType, literal: &str) {
        ...
        let len = text.len();
        self.tokens
            .push(Token::new(token_type, text, literal.to_string(), self.pos()));
...
mod tests {
    ...
    fn test_tokenize() {
        ...
        assert_eq!(
            tokens,
            &vec![
                Token::new(TokenType::Let, String::from("let"), String::from(""), (1, 1)),
                Token::new(TokenType::Identifier, String::from("x"), String::from(""), (1, 5)),
                Token::new(TokenType::Equal, String::from("="), String::from(""), (1, 7)),
                Token::new(TokenType::NumberInt, String::from("100"), String::from("100"), (1, 9)),
                Token::new(TokenType::Semicolon, String::from(";"), String::from(""), (1, 12)),
    ...
    fn test_err_tokenize() {
        ...
        assert_eq!(
            tokens,
            &vec![
                Token::new(TokenType::Const, String::from("const"), String::from(""), (1, 1)),
                Token::new(TokenType::Identifier, String::from("X"), String::from(""), (1, 7)),
                Token::new(TokenType::Equal, String::from("="), String::from(""), (1, 9)),
        ...
        let (tokens, err) = lexer.tokenize();
        assert!(err);
        assert_eq!(tokens, &vec![Token::new(TokenType::Eof, String::from(""), String::from(""), (1, 1)),]);
    }
}
